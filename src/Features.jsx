  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} style={{ textAlign: 'center', marginBottom: '4rem' }}>
        ...
        <p style={{ color: 'var(--color-text-secondary)', fontSize: '1rem', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        {featureList.map((feature, idx) => (
          ...
          >
            <motion.div 
              ...
              style={{ fontSize: '2.5rem', marginBottom: '1.2rem', display: 'inline-block' }}
            >
              {feature.icon}
            </motion.div>
            <h3 style={{ fontSize: '1.15rem', fontWeight: '800', marginBottom: '0.6rem' }}>{feature.title}</h3>
            <p style={{ color: 'var(--color-text-secondary)', lineHeight: 1.6, fontSize: '0.9rem', marginBottom: '1.2rem' }}>{feature.desc}</p>
            <motion.div 
              whileHover={{ x: 5 }}
              style={{ color: 'var(--color-primary)', fontWeight: '700', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}
            >
      ...
      >
        <h2 style={{ fontSize: '1.5rem', fontWeight: '800', marginBottom: '0.8rem' }}>AI kami terus belajar</h2>
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: '1.5rem', fontSize: '0.9rem' }}>Setiap fitur dirancang dengan masukan dari perekrut profesional dan engineer AI terbaik.</p>
        <div style={{ display: 'flex', justifyContent: 'center', gap: '2.5rem', flexWrap: 'wrap' }}>
          {[
            ...
            <div key={i}>
              <div style={{ fontSize: '1.6rem', fontWeight: '900', color: 'var(--color-primary)' }}>{s.n}</div>
              <div style={{ fontSize: '0.75rem', color: 'var(--color-text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{s.l}</div>
            </div>
          ))}
        </div>
      </motion.div>
